<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tceel.aspx.cs" validateRequest="false" Inherits="SAES_v1.tceel" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/tcodo.png" style="width: 30px;" /><small>Certificación Electrónica</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tceel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_tceel" runat="server">
                    ...
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        ...
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_claveGenero" class="form-label">Clave Genero</label>
                                <asp:Label ID="lb_claveGenero" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_genero" class="form-label">Genero</label>                          
                                <asp:Label ID="lb_genero" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_fechaNacimiento" class="form-label">Fecha Nacimiento</label>
                            <asp:Label ID="lb_fechaNacimiento" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_fechaExpedicion" class="form-label">Fecha Expedición</label>
                            <asp:Label ID="lb_fechaExpedicion" runat="server" CssClass="form-control" AutoPostBack="true" ></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_clavePeriodicidad" class="form-label">Clave Periodicidad</label>                            
                            <asp:Label ID="lb_clavePeriodicidad" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_periodicidad" class="form-label">Periodicidad</label>
                            <asp:Label ID="lb_periodicidad" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_plan" class="form-label">Plan</label>
                            <asp:Label ID="lb_plan" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                    </div>
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_claveNivelEstudios" class="form-label">Clave Nivel Estudios</label>
                            <asp:Label ID="lb_claveNivelEstudios" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_nivelEstudios" class="form-label">Nivel Estudios</label>
                            <asp:Label ID="lb_nivelEstudios" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_creditos" class="form-label">Créditos</label>
                            <asp:Label ID="lb_creditos" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                    </div>
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_califMinima" class="form-label">Calif. Mínima</label>
                            <asp:Label ID="lb_califMinima" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_califMaxima" class="form-label">Calif. Máxima</label>
                            <asp:Label ID="lb_califMaxima" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_califMinAprobatoria" class="form-label">Calif. Mín. Aprobatoría</label>
                            <asp:Label ID="lb_califMinAprobatoria" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                    </div>
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;"></div>
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <asp:Label ID="lb_TipoCertificado" runat="server" CssClass="form-control" AutoPostBack="false" style="text-align: center;" >CERTIFICADO [  ]</asp:Label>
                    </div>
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;"></div>
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-4">
                    ...
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_califMinAprobatoria" class="form-label">Total Materias</label>
                            <asp:Label ID="lb_materias" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                         <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_califMinAprobatoria" class="form-label">Promedio</label>
                            <asp:Label ID="lb_promedio" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                         <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_califMinAprobatoria" class="form-label">Total Créditos</label>
                            <asp:Label ID="lb_totalCreditos" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                         <div class="col-md-3">
                            <label for="ContentPlaceHolder1_lb_califMinAprobatoria" class="form-label">No. Ciclos</label>
                            <asp:Label ID="lb_noCiclos" runat="server" CssClass="form-control" AutoPostBack="false" ></asp:Label>
                        </div>
                    </div>
                    <div id="table_tceel">
                        <div style="margin-top: 15px;">
                            <asp:GridView ID="Gridtceel" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" >
                                <Columns>
                                    <asp:BoundField DataField="Clave" HeaderText="Clave" />
                                    <asp:BoundField DataField="IdAsignatura" HeaderText="Clave Asignatura" />
                                    <asp:BoundField DataField="Materia" HeaderText="Materia" />
                                    <asp:BoundField DataField="Ciclo" HeaderText="Ciclo" />
                                    <asp:BoundField DataField="CicloSAES" HeaderText="Ciclo SAES" />                                    
                                    ...
                                    <asp:BoundField DataField="ClaveTipo" HeaderText="Clave Tipo" />
                                    <asp:BoundField DataField="IdObservaciones" HeaderText="Clave Observaciones" />
                                    <asp:BoundField DataField="IdTipoAsignatura" HeaderText="Clave Tipo Asignatura" />
