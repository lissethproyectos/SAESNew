    ...
    <script>
        ...
        function error() {
            swal({
                ...
                allowOutsideClick: false,
                type: 'success',
                html: '<h2 class="swal2-title" id="swal2-title">Error !!!</h2>Los valores deben ser numéricos'
            })
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <i class="fa fa-list-ol" aria-hidden="true"></i><small>Secuencias por Campus</small></h2>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_programa" runat="server">
                    <div class="form-row">
                        <div class="col-sm-6">
                            <label for="ContentPlaceHolder1_search_campus" class="form-label">Campus</label>
                ...
                <div class="row">
                    <div class="col">
                        <asp:GridView ID="GridSequence" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="False" EmptyDataText="No se encontraron secuencias." ShowHeaderWhenEmpty="True">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Valor">
                                    <ItemTemplate>
                                        <asp:TextBox ID="valor" runat="server" CssClass="form-control" Text='<%# Bind("tcseq_numero") %>' />
                                    </ItemTemplate>
                                    <ItemStyle Width="15%" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Longitud">
                                    <ItemTemplate>
                                        <asp:TextBox ID="longitud" runat="server" CssClass="form-control" Text='<%# Bind("tcseq_longitud") %>' />
                                    </ItemTemplate>
                                    <ItemStyle Width="15%" />
                                </asp:TemplateField>
                ...
                <div class="row">
                    <div class="col" id="btn_seq" runat="server">
                  <%--      <asp:Button ID="cancelar_seq" runat="server" CssClass="btn btn-round btn-secondary" Text="Cancelar" OnClick="cancelar_seq_Click" />
                        <asp:Button ID="guardar_seq" runat="server" CssClass="btn btn-round btn-success" Text="Guardar" OnClick="guardar_seq_Click" />--%>
                    </div>
                </div>
    ...
    <script>
        function load_datatable() {
                $('#<%= GridSequence.ClientID %>').prepend($("<thead></thead>").append($('#<%= GridSequence.ClientID %>').find("tr:first"))).DataTable({
