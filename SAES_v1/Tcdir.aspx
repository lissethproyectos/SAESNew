<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tcdir.aspx.cs" Inherits="SAES_v1.Tcdir" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Admisiones/buscar.png" style="width: 30px;" /><small>Consulta Direcciones</small></h2>
            ...
            <ContentTemplate>
                ...
                <div id="Div1" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        ...
                        <div class="col-md-4">
                            <label for="ContentPlaceHolder1_ddl_dele" class="form-label">Alcaldía/Municipio</label>
                            <asp:DropDownList ID="ddl_dele" runat="server" CssClass="form-control" ></asp:DropDownList>   
                        </div>  
                    </div>
                </div>
                ...
                <div id="table_tcdoc">
                    <asp:GridView ID="GridDirecciones" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small">
                         <Columns>
                            ...
                            <asp:BoundField DataField="tipo_dir" HeaderText="Tipo" />
                            <asp:BoundField DataField="pais" HeaderText="País" />
                             <asp:BoundField DataField="estado" HeaderText="Estado" />
                             <asp:BoundField DataField="dele" HeaderText="Alcaldía/Municipio" />
    ...
    <script>
        function load_datatable() {
            let table_solicitudes = $("#ContentPlaceHolder1_GridDirecciones").DataTable({
                language: {
                ...
                buttons: [
                    {
                        title: 'SAES_Consulta Direcciones',
                        className: 'btn-dark',
                        extend: 'excel',
                        text: 'Exportar Excel',
                        exportOptions: {
