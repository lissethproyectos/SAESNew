<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tccor.aspx.cs" Inherits="SAES_v1.Tccor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;Consulta Correos
        </h2>
...
<%--                <asp:LinkButton ID="back" runat="server" CssClass=" icon_regresa  btn-outline-secondary" OnClick="back_Click"><i class="fas fa-arrow-circle-left fa-2x"></i></asp:LinkButton>--%>
                ...
                <div class="row" id="btn_tcdoc" runat="server">
                    <div class="col text-center">
                        <asp:LinkButton ID="linkRegresar" runat="server" class="btn btn-round btn-dark" OnClick="back_Click"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>&nbsp;Regresar</asp:LinkButton>
                        &nbsp;
                        <asp:Button ID="btn_cancel" runat="server" CssClass="btn btn-round btn-dark" Text="Cancelar" OnClick="btn_cancel_Click"/>
                        &nbsp;
                        <asp:Button ID="btn_consultar" runat="server" CssClass="btn btn-round btn-success" Text="Consultar" OnClick="btn_consultar_Click"/>
                    </div>
                </div>
                <div id="table_tcdoc">
                    <asp:GridView ID="GridCorreos" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small">
                         <Columns>
                            ...
                            <asp:BoundField DataField="tipo_correo" HeaderText="Tipo" />
                            <asp:BoundField DataField="correo" HeaderText="Correo" />
                            <asp:BoundField DataField="prefer" HeaderText="Preferido" />
    ...
    <script>
        function load_datatable() {
            let table_solicitudes = $("#ContentPlaceHolder1_GridCorreos").DataTable({
                language: {
