                              ...
                              <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                  <ContentTemplate>
                                      <div class="input-group">
                                          <asp:TextBox ID="txt_matricula" runat="server" CssClass="form-control" AutoPostBack="True" OnTextChanged="linkBttnBusca_Click" ></asp:TextBox><!--Configurar BackEnd la longitud de la BD-->
            ...
            <div class="col-sm-12">
                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Button ID="btn_correos" runat="server" CssClass="btn btn-round btn-success" Text="Lista Correos" OnClick="btn_correos_Click" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridCorreo" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="GridCorreo_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No se encontraron correos para este alumno.">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="linkBttSel" runat="server" CausesValidation="False" CommandName="Select" Text="Seleccionar">
