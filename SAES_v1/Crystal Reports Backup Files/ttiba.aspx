<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ttiba.aspx.cs" Inherits="SAES_v1.ttiba" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
   ...
   <script>
       ...
       function validar_campos_ttiba(e) {
           event.preventDefault(e);
           validarClave('ContentPlaceHolder1_txt_ttiba',0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/baja.png" style="width: 30px;" /><small>Tipos de Baja</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_ttiba" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_ttiba" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_ttiba" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_ttiba" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_ttiba" runat="server" visible="false">
                ...
                <div id="table_ttiba">
                    <asp:GridView ID="Gridttiba" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridttiba_SelectedIndexChanged">
                        <Columns>
 ...
 <script>
     function load_datatable() {
         let table_periodo = $("#ContentPlaceHolder1_Gridttiba").DataTable({
             language: {
             ...
             buttons: [
                 {
                     title: 'SAES_Catálogo Tipos de Baja',
                     className: 'btn-dark',
                     extend: 'excel',
                     text: 'Exportar Excel',
                     exportOptions: {
     ...
     function destroy_table() {
         $("#ContentPlaceHolder1_Gridttiba").DataTable().destroy();
     }
