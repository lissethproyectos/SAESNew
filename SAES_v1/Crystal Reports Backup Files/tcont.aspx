<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tcont.aspx.cs" Inherits="SAES_v1.tcont" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
   ...
   <script>
       ...
       function validar_campos_tcont(e) {
           event.preventDefault(e);
           validarClave('ContentPlaceHolder1_txt_tcont',0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/contacto.png" style="width: 30px;" /><small>Tipos de Contacto</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <ul class="nav nav-tabs justify-content-end">
        </ul>
        <asp:UpdatePanel ID="upd_tcont" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_tcont" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_tcont" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tcont" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tcont" runat="server">
                ...
                <div id="table_tcont">
                    <asp:GridView ID="Gridtcont" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtcont_SelectedIndexChanged">
                        <Columns>
 ...
 <script>
     function load_datatable() {
         let table_periodo = $("#ContentPlaceHolder1_Gridtcont").DataTable({
             language: {
             ...
             buttons: [
                 {
                     title: 'SAES_Catálogo de Tipos Contacto',
                     className: 'btn-dark',
                     extend: 'excel',
                     text: 'Exportar Excel',
                     exportOptions: {
     ...
     function destroy_table() {
         $("#ContentPlaceHolder1_Gridtcont").DataTable().destroy();
     }
