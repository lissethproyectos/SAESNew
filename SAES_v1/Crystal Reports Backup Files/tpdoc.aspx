...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Admisiones/tarjeta_usuario.png" style="width: 30px;" /><small>Datos Personales Docente</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tpdoc" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tpdoc" runat="server">
