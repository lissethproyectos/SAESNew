<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tmoda.aspx.cs" Inherits="SAES_v1.tmoda" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/modalidad.jpg" style="width: 30px;" /><small>Modalidad de Estudios</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tmoda" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_tmoda" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_tmoda" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tmoda" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tmoda" runat="server">
                ...
                <div id="table_tmoda">
                    <asp:GridView ID="Gridtmoda" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtmoda_SelectedIndexChanged">
                        <Columns>
 ...
 <script>
     function load_datatable() {
         let table_periodo = $("#ContentPlaceHolder1_Gridtmoda").DataTable({
             language: {
             ...
             buttons: [
                 {
                     title: 'SAES_Catálogo Modalidad de Estudios',
                     className: 'btn-dark',
                     extend: 'excel',
                     text: 'Exportar Excel',
                     exportOptions: {
     ...
     function destroy_table() {
         $("#ContentPlaceHolder1_Gridttmoda").DataTable().destroy();
     }
