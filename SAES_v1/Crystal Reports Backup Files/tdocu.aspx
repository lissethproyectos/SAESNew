<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tdocu.aspx.cs" Inherits="SAES_v1.tdocu" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
   ...
   <script>
       ...
       function validar_campos_tdocu(e) {
           event.preventDefault(e);
           validarClave('ContentPlaceHolder1_txt_tdocu',0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/doctos.png" style="width: 30px;" /><small>Catálogo de Documentos</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tdocu" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_periodos" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_tdocu" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tdocu" MaxLength="6" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_ddl_formato" class="form-label">Formato</label>
                            <asp:DropDownList ID="ddl_formato" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tdocu" runat="server">
                ...
                <div id="table_tdocu">
                    <asp:GridView ID="Gridtdocu" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtdocu_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:BoundField DataField="C_FORMATO" HeaderText="Formato">
                                <HeaderStyle CssClass="ocultar" />
                                <ItemStyle CssClass="ocultar" />
                            </asp:BoundField>
 ...
 <script>
     function load_datatable() {
         let table_periodo = $("#ContentPlaceHolder1_Gridtdocu").DataTable({
             ...
             buttons: [
                 {
                     title: 'SAES_Catálogo de Documentos',
                     className: 'btn-dark',
                     extend: 'excel',
                     text: 'Exportar Excel',
                     exportOptions: {
