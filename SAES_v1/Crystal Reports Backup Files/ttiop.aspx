...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/tcodo.png" style="width: 30px;" /><small>Catálógo de Opciones de Titulación</small></h2>
            ...
            <ContentTemplate>
                ...
                <div id="table_ttiop_det">
                    <div style="margin-top: 15px;">
                        ...
                        <%--<asp:Button ID="btn_AddRow" runat="server" CssClass="btn btn-round btn-success" Text="AgregarOpcion" OnClick="btn_addrow_Click" />  --%>
                    </div>
                </div>
