                ...
                <div id="form_talte" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        ...
                        <div class="col-md-2">
                            ...
                            <asp:TextBox ID="txt_lada" MaxLength="2" runat="server" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_telefono" class="form-label">Teléfono</label>
                            <asp:TextBox ID="txt_telefono" MaxLength="8" runat="server" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
