                ...
                <div id="form_talte" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        ...
                        <div class="col-md-2">
                            ...
                            <asp:TextBox ID="txt_lada" MaxLength="3" runat="server" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_telefono" class="form-label">Teléfono</label>
                            <asp:TextBox ID="txt_telefono" MaxLength="12" runat="server" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-md-2">
                            <label for="ContentPlaceHolder1_txt_extension" class="form-label">Extensión</label>
                            <asp:TextBox ID="txt_extension" MaxLength="5" runat="server" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-1">
                            <label for="ContentPlaceHolder1_consulta_docs" class="form-label">Consulta Teléfonos</label><br />
