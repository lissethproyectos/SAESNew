<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tstso.aspx.cs" Inherits="SAES_v1.tstso" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
   ...
   <script>
       ...
       function validar_campos_tstso(e) {
           event.preventDefault(e);
           validarClave('ContentPlaceHolder1_txt_tstso',0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Admisiones/solicitud.png" style="width: 30px;" /><small>Catálogo Estatus Solicitud</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tstso" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_tstso" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_tstso" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tstso" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tstso" runat="server">
                ...
                <div id="table_tstso">
                    <asp:GridView ID="Gridtstso" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtstso_SelectedIndexChanged">
                        <Columns>
 ...
 <script>
     function load_datatable() {
         let table_periodo = $("#ContentPlaceHolder1_Gridtstso").DataTable({
             language: {
             ...
             buttons: [
                 {
                     title: 'SAES_Catálogo Estatus Solicitud',
                     className: 'btn-dark',
                     extend: 'excel',
                     text: 'Exportar Excel',
                     exportOptions: {
     ...
     function destroy_table() {
         $("#ContentPlaceHolder1_Gridtstso").DataTable().destroy();
     }
