...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/tstdo.jpg" style="width: 30px;" /><small>Estatus de Documentos</small></h2>
            ...
            <ContentTemplate>
                <div id="form_periodos" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_tstdo" class="form-label">Clave</label>
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tstdo" runat="server">
