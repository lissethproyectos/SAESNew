...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Admisiones/mapa.png" style="width: 30px;" /><small>Dirección Contactos</small></h2>
    ...
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tladi" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tcodi" runat="server">
