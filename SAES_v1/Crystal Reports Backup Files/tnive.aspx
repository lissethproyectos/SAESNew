...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/nivel.png" style="width: 30px;" /><small>Niveles Educativos</small></h2>
    ...
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tnive" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tnive" runat="server">
