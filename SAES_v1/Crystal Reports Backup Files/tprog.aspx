...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/programs.jpg" style="width: 30px;" /><small>Programas Académicos</small></h2>
    ...
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tprog" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tprog" runat="server">
