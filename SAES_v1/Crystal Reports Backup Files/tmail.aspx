<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tmail.aspx.cs" Inherits="SAES_v1.tmail" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
   ...
   <script>
       ...
       function validar_campos_tmail(e) {
           event.preventDefault(e);
           validarClave('ContentPlaceHolder1_txt_tmail',0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/correo.png" style="width: 30px;" /><small>Tipos de Correo electrónico</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tmail" runat="server" UpdateMode="Conditional">          
            <ContentTemplate>
                <div id="form_tmail" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_tmail" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tmail" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tmail" runat="server">
                ...
                <div id="table_tmail">
                    <asp:GridView ID="Gridtmail" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtmail_SelectedIndexChanged">
                        <Columns>
 ...
 <script>
     function load_datatable() {
         let table_periodo = $("#ContentPlaceHolder1_Gridtmail").DataTable({
             language: {
             ...
             buttons: [
                 {
                     title: 'SAES_Catálogo de Tipos Correo Electrónico',
                     className: 'btn-dark',
                     extend: 'excel',
                     text: 'Exportar Excel',
                     exportOptions: {
     ...
     function destroy_table() {
         $("#ContentPlaceHolder1_Gridtmail").DataTable().destroy();
     }
