<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tcoca.aspx.cs" Inherits="SAES_v1.tcoca" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
   ...
   <script>
       ...
       function validar_campos_tcoca(e) {
           event.preventDefault(e);
           validarClave('ContentPlaceHolder1_txt_tcoca',0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/tcoca.jpg" style="width: 30px;" /><small>Conceptos Calendario Escolar</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tcoca" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_tcoca" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_tcoca" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tcoca" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tcoca" runat="server" visible="false">
                ...
                <div id="table_tcoca">
                    <asp:GridView ID="Gridtcoca" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtcoca_SelectedIndexChanged">
                        <Columns>
 ...
 <script>
     function load_datatable() {
         let table_periodo = $("#ContentPlaceHolder1_Gridtcoca").DataTable({
             language: {
             ...
             buttons: [
                 {
                     title: 'SAES_Conceptos Calendario Escolar',
                     className: 'btn-dark',
                     extend: 'excel',
                     text: 'Exportar Excel',
                     exportOptions: {
     ...
     function destroy_table() {
         $("#ContentPlaceHolder1_Gridtcoca").DataTable().destroy();
     }
