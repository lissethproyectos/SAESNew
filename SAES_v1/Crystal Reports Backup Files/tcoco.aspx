...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/salon.png" style="width: 30px;" /><small>Conceptos Cobranza</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tcoco" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_tcoco" runat="server">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tcoco" runat="server">
