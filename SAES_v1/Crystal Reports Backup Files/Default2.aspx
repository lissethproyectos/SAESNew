...
<body translate="no">
    ...
    <form id="formulario" class="login-form2" runat="server">
            ...
            <ContentTemplate>
                <asp:MultiView ID="multiViewUsu" runat="server">
                    <asp:View ID="View1" runat="server">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-2 lf--input2">Pregunta de seguridad</div>
                                <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-md-2 lf--input2">Respuesta</div>
                                <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-md-6 text-right">
                                     <asp:UpdatePanel ID="updPnlBotonesC" runat="server">
                                        <ContentTemplate>
                                    <asp:LinkButton ID="linkBttnCancelar" CssClass="btn-success" runat="server" OnClick="linkBttnCancelar_Click">Cancelar</asp:LinkButton>
                                             </ContentTemplate>
                                         </asp:UpdatePanel>
                                     </div>
                                ...
                                <div class="col-md-6 text-right">
                                     <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                    <asp:LinkButton ID="linkBttnVerificaRespuesta"  CssClass="form-control boton-round boton-success" runat="server" OnClick="linkBttnVerificaRespuesta_Click">Verificar</asp:LinkButton>
