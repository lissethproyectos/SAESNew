<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tcadm.aspx.cs" Inherits="SAES_v1.Tcadm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Admisiones/buscar.png" style="width: 30px;" /><small>Consulta Solicitudes Admisión</small></h2>
        ...
        <asp:UpdatePanel ID="upd_c_documentos" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div id="Div1" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_ddl_tiin" class="form-label">Tipo Ingreso</label>
                            <asp:DropDownList ID="ddl_tiin" runat="server" CssClass="form-control" ></asp:DropDownList>                            
                        </div>
                        <div class="col-md-4">
                            <label for="ContentPlaceHolder1_ddl_espr" class="form-label">Escuela Procedencia</label>
                            <asp:DropDownList ID="ddl_espr" runat="server" CssClass="form-control" ></asp:DropDownList>   
                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_ddl_tasa" class="form-label">Tasa financiera</label>
                ...
                <div id="table_tcdoc">
                    <asp:GridView ID="GridSolicitud" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small">
                         <Columns>
                            ...
                            <asp:BoundField DataField="tipo_ingreso" HeaderText="Tipo Ingreso" />
    ...
    <script>
        function load_datatable() {
            let table_solicitudes = $("#ContentPlaceHolder1_GridSolicitud").DataTable({
                ...
                buttons: [
                    {
                        title: 'SAES_Consulta Solicitudes Admisión',
                        className: 'btn-dark',
                        extend: 'excel',
                        text: 'Exportar Excel',
                        exportOptions: {
