<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ttama.aspx.cs" Inherits="SAES_v1.ttama" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>  
       ...
       function validarTipo(idEl) {
        ...
        //---- Clave ----//
       function validarNoMaterias(idEl) {
           const idElemento = idEl;
           let nombre = document.getElementById(idElemento).value;
           if (nombre == null || nombre.length == 0 || /^\s+$/.test(nombre)) {
               errorForm(idElemento, 'Ingresar No.Materias');
               return false;
           } else {
               validadoForm(idElemento);
           }
        ...
        function validar_campos_tasa(e) {
            ...
            validarNoMaterias('ContentPlaceHolder1_txt_numero');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/capr.png" style="width: 30px;" /><small>Número de materias por Tasa</small></h2>
                ...
                <div id="form_programa" runat="server">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                                <div class="col-md-2">
                                    <label for="ContentPlaceHolder1_c_prog_campus" class="form-label">No.Materias</label>
                ...
                <div id="tabla_conceptos" style="margin-top: 15px;" runat="server">
                    <asp:GridView ID="GridConceptos" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="GridConceptos_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Numero" HeaderText="Número Materias" />
                            <asp:BoundField DataField="TTIMA" HeaderText="Tipo_Mteria">
                                <HeaderStyle CssClass="ocultar" />
                                <ItemStyle CssClass="ocultar" />
                            </asp:BoundField>
    ...
    <script>
        ...
        function load_datatable() {
            let table_programas = $("#ContentPlaceHolder1_GridConceptos").DataTable({                
                ...
                buttons: [
                    {
                        title: 'SAES_Catálogo de Tasa-No.Materias',
                        className: 'btn-dark',
                        extend: 'excel',
                        text: 'Exportar Excel',
                        exportOptions: {
