...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/salon.png" style="width: 30px;" /><small>Escenarios Académicos</small></h2>
    ...
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tsalo" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tsalo" runat="server">
                ...
                <div id="table_tsalo">
                    <asp:GridView ID="Gridtsalo" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtsalo_SelectedIndexChanged">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Tipo" HeaderText="Tipo_Salón" />
