<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tcomp.aspx.cs" Inherits="SAES_v1.Tcomp" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ul class="nav nav-tabs justify-content-center">
            <li class="nav-item">
                <a class="nav-link active" href="Tcomp.aspx">Componentes</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="Tcocx.aspx">Configuración</a>
            </li>
    </ul>
    <div class="x_title">
        <h2>
            <img src="Images/Operaciones/tcomp.png" style="width: 30px;" /><small>Componentes de Calificación</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tcomp" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_periodos" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-2">
                            <label for="ContentPlaceHolder1_txt_tcomp" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tcomp" MaxLength="6" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-5">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_tcomp" runat="server">
                ...
                <div id="table_tcomp">
                    <asp:GridView ID="Gridtcomp" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtcomp_SelectedIndexChanged">
                        <Columns>
 ...
 <script>
     function load_datatable() {
         let table_periodo = $("#ContentPlaceHolder1_Gridtcomp").DataTable({
             language: {
             ...
             buttons: [
                 {
                     title: 'SAES_Componentes Calificación',
                     className: 'btn-dark',
                     extend: 'excel',
                     text: 'Exportar Excel',
                     exportOptions: {
     ...
     function destroy_table() {
         $("#ContentPlaceHolder1_Gridtcomp").DataTable().destroy();
     }
