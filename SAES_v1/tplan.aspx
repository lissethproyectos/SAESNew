...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>  
        ...
        function NoexistePrograma() {
            swal({
                allowEscapeKey: false,
                allowOutsideClick: false,
                type: 'error',
                html: '<h2 class="swal2-title" id="swal2-title">ERROR !!</h2>Programa NO existe'
            })
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <asp:UpdatePanel ID="updPnlBusca" runat="server">
                    <ContentTemplate>
                        <div class="input-group">
                            <asp:TextBox ID="txt_tprog" runat="server" CssClass="form-control" ReadOnly="true" AutoPostBack="true"></asp:TextBox>
                            ...
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalProgramas">
                ...
                <div class="form-row">
                    <div class="col-sm-2">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <div class="input-group">
                                    <asp:TextBox ID="txt_tmate" runat="server" CssClass="form-control" ReadOnly="true" AutoPostBack="true"></asp:TextBox>
                                    ...
                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalMaterias">
                                        <i class="fa fa-search" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </ContentTemplate>
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-2">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
                                <div class="input-group">
                                    <asp:TextBox ID="txt_tarea" runat="server" CssClass="form-control" ReadOnly="true" AutoPostBack="true"></asp:TextBox>
                                    ...
                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalAreas">
                                        <i class="fa fa-search" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </ContentTemplate>
                    ...
                    <div class="col-md-2">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                            <ContentTemplate>
                                <div class="input-group">
                                    <asp:TextBox ID="txt_tpees" runat="server" CssClass="form-control" ReadOnly="true" AutoPostBack="true"></asp:TextBox>
                                    ...
                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalPeriodos">
                                        <i class="fa fa-search" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </ContentTemplate>
        ...
        <div class="row">
            <div class="col text-center">
                <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="Gridtplan" runat="server" CssClass="table table-striped table-bordered" ShowHeaderWhenEmpty="true" ShowHeader="true" OnSelectedIndexChanged="Gridtplan_SelectedIndexChanged" EmptyDataText="No se encontraron planes.">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="linkBttSel" runat="server" CausesValidation="False" CommandName="Select" Text="Seleccionar">
    <i class="fa fa-paper-plane" aria-hidden="true"></i>
                                ...
                                <asp:BoundField DataField="c_area" HeaderText="c_area">
                                    <HeaderStyle CssClass="no_mostrar" />
                                    <ItemStyle CssClass="no_mostrar" />
                                </asp:BoundField>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="Gridtprog" runat="server" CssClass="table table-striped table-bordered" UseAccessibleHeader="true" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtprog_SelectedIndexChanged">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="linkBttSel" runat="server" CausesValidation="False" CommandName="Select" Text="Seleccionar">
        ...
        <!-- Modal Materias -->
        <div class="modal fade bd-example-modal-lg" id="modalMaterias" tabindex="-1" role="dialog" aria-labelledby="modalMats" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="Gridtmate" runat="server" UseAccessibleHeader="true" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtmate_SelectedIndexChanged" ShowHeader="true" ShowHeaderWhenEmpty="true" OnRowCreated="Gridtmate_RowCreated">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="linkBttSel" runat="server" CausesValidation="False" CommandName="Select" Text="Seleccionar">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView ID="Gridtarea" runat="server" CssClass="table table-striped table-bordered" UseAccessibleHeader="true" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" ShowHeader="true" ShowHeaderWhenEmpty="true" OnSelectedIndexChanged="Gridtarea_SelectedIndexChanged" OnRowCreated="Gridtarea_RowCreated">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="linkBttSel" runat="server" CausesValidation="False" CommandName="Select" Text="Seleccionar">
    ...
    <script>
        ...
        function load_datatable_Materia2() {
        ...
        function load_datatable_Materia() {
            $('#<%= Gridtmate.ClientID %>').DataTable({
                scrollX: true, // fuerza ancho completo si hay columnas largas
                autoWidth: false,
                responsive: true,
                language: {
                    sLengthMenu: 'Mostrar _MENU_ registros',
        ...
        function load_datatable_Area() {
            $('#<%= Gridtarea.ClientID %>').prepend($("<thead></thead>").append($('#<%= Gridtarea.ClientID %>').find("tr:first"))).DataTable({
                scrollX: true, // fuerza ancho completo si hay columnas largas
                autoWidth: false,
                responsive: true,
                language: {
        ...
        function load_datatable() {
            $('#<%= Gridtplan.ClientID %>').prepend($("<thead></thead>").append($('#<%= Gridtplan.ClientID %>').find("tr:first"))).DataTable({
                language: {
                    bProcessing: 'Procesando...',
                    sLengthMenu: 'Mostrar _MENU_ registros',
                    sZeroRecords: 'No se encontraron resultados',
