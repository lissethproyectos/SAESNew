...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col">
            <h2>
                <i class="fa fa-user-circle" aria-hidden="true"></i>&nbsp;Consulta Datos Personales</h2>
        </div>
    </div>
    <hr />
    <div class="x_content">
        ...
        <asp:UpdatePanel ID="upd_c_documentos" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <br />
                <div class="form-row text-center" id="btn_tcdoc" runat="server">
                    <div class="col">
                        <asp:LinkButton ID="linkRegresar" runat="server" class="btn btn-round btn-dark" data-dismiss="modal" OnClick="back_Click"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>&nbsp;Regresar</asp:LinkButton>
                        &nbsp;
                ...
                <div class="form-row" id="table_tcdoc">
                     <div class="col">
