...
{
    public partial class Permisos2 : System.Web.UI.Page
    {
        ...
        protected void CargaListaDoc_Usuarios()
        {
            ...
            catch (Exception ex)
            {
                ...
                Global.inserta_log(mensaje_error, "permisos", Session["usuario"].ToString());
        ...
        protected void linkBttnAgregarUsuCampus_Click(object sender, EventArgs e)
        {
        ...
        protected void linkBttnEliminarUsuCampus_Click(object sender, EventArgs e)
        {
            for (int x = 0; x < lstCampus.GetSelectedIndices().Length; x++)
            {
                string IDCampus = lstCampus.Items[lstCampus.GetSelectedIndices()[x]].Value;
        ...
        protected void linkBttnDerDoctosStatus_Click(object sender, EventArgs e)
        {

        }

        protected void linkBttnAgregarNiv_Click(object sender, EventArgs e)
        {
            for (int x = 0; x < ListNiveles.GetSelectedIndices().Length; x++)
            {
                string IDNivel = ListNiveles.Items[ListNiveles.GetSelectedIndices()[x]].Value;
        ...
        protected void linkBttnEliminarNiv_Click(object sender, EventArgs e)
        {

        }

        protected void linkBttnAddNivel_Click(object sender, EventArgs e)
        {
            for (int x = 0; x < ListNiveles.GetSelectedIndices().Length; x++)
            {
                string IDNivel = ListNiveles.Items[ListNiveles.GetSelectedIndices()[x]].Value;
        ...
        protected void linkBttnDelNivel_Click(object sender, EventArgs e)
        {
            for (int x = 0; x < ListNiveles.GetSelectedIndices().Length; x++)
            {
                string IDNivel = ListNiveles.Items[ListNiveles.GetSelectedIndices()[x]].Value;
        ...
        protected void linkBttnAddUsuDoctos_Click(object sender, EventArgs e)
        {
            for (int x = 0; x < ListDocumentos.GetSelectedIndices().Length; x++)
            {
                string IDTipoDocumento = ListDocumentos.Items[ListDocumentos.GetSelectedIndices()[x]].Value;
        ...
        protected void linkBttnDelUsuDoctos_Click(object sender, EventArgs e)
        {
            for (int x = 0; x < ListDocumentos.GetSelectedIndices().Length; x++)
            {
                string IDTipoDocumento = ListDocumentos.Items[ListDocumentos.GetSelectedIndices()[x]].Value;
        ...
        protected void linkBttnDoctosEstatusDer_Click(object sender, EventArgs e)
        {
            for (int x = 0; x < ListDocs.GetSelectedIndices().Length; x++)
            {
                string IDTipoDocumento = ListDocs.Items[ListDocs.GetSelectedIndices()[x]].Value;
        ...
        protected void linkBttnDoctosEstatusIzq_Click(object sender, EventArgs e)
        {
            for (int x = 0; x < ListDocs.GetSelectedIndices().Length; x++)
            {
                string IDTipoDocumento = ListDocs.Items[ListDocs.GetSelectedIndices()[x]].Value;
        ...
        protected void linkBttnAgregarUsuCampus_Click1(object sender, EventArgs e)
        {
