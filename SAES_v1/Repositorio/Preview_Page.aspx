...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="revision_doc_panel">
                    <div class="form-row">
                        <div class="col-sm-4">
                            Asignar Estatus
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:DropDownList ID="DropDownEstatus" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DropDownEstatus_SelectedIndexChanged"></asp:DropDownList>
                                </ContentTemplate>
                                <Triggers>
                    ...
                    <div class="form-row">
                        <div class="col-sm-12 text-center">
                            <asp:Button ID="Guarda_Rev" runat="server" Text="Guardar" CssClass="btn btn-success" OnClick="Guarda_Rev_Click" />&nbsp;<asp:Button ID="Button1" runat="server" Text="Cancelar" OnClientClick="slide_up(); return false" CssClass="btn btn-secondary" />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-sm-12">
