<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ttiin.aspx.cs" Inherits="SAES_v1.ttiin" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Admisiones/agregar-usuario.png" style="width: 30px;" /><small>Catálogo Tipos de Ingreso</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_ttiin" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_ttiin" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_ttiin" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_ttiin" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_ttiin" runat="server">
                ...
                <div id="table_ttiin">
                    <asp:GridView ID="Gridttiin" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridttiin_SelectedIndexChanged">
                        <Columns>
 ...
 <script>
     function load_datatable() {
         let table_periodo = $("#ContentPlaceHolder1_Gridttiin").DataTable({
             language: {
             ...
             buttons: [
                 {
                     title: 'SAES_Catálogo Tipos de Ingreso',
                     className: 'btn-dark',
                     extend: 'excel',
                     text: 'Exportar Excel',
                     exportOptions: {
     ...
     function destroy_table() {
         $("#ContentPlaceHolder1_Gridttiin").DataTable().destroy();
     }
