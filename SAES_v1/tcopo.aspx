...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <i class="fa fa-home fa-2x" aria-hidden="true"></i>&nbsp;Códigos Postales
            </div>
        </div>
        <hr />
       ...
       <%-- <div class="row">
            <div class="col text-center">
                <asp:UpdateProgress ID="updPgrTcopo" runat="server"
                    AssociatedUpdatePanelID="updPnlTcopo">
                    <ProgressTemplate>
            ...
            <div class="form-row">
                <div class="col-sm-4">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="cbop_zip" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="cbop_zip_SelectedIndexChanged"></asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <div class="col-sm-4">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="cboe_zip" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="cboe_zip_SelectedIndexChanged"></asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <div class="col-sm-4">
                    <label for="ContentPlaceHolder1_cbod_zip" class="form-label">Delegacion/Municipio</label>
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="cbod_zip" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="cbod_zip_SelectedIndexChanged"></asp:DropDownList>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
        ...
        <div class="row" id="btn_zip" runat="server">
            <div class="col text-center">
                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="cancel_zip" runat="server" CssClass="btn btn-round btn-secondary" Text="Cancelar" OnClick="cancel_zip_Click" Visible="false" />
        ...
        <div id="tabla_zip">
            <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridZip" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" OnSelectedIndexChanged="GridZip_SelectedIndexChanged" ShowHeaderWhenEmpty="True">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
    ...
    <script>
        function load_datatable() {
            $('#<%= GridZip.ClientID %>').prepend($("<thead></thead>").append($('#<%= GridZip.ClientID %>').find("tr:first"))).DataTable({
                language: {
