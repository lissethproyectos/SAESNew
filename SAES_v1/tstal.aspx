<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tstal.aspx.cs" Inherits="SAES_v1.tstal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function validar_campos_tstal(e) {
            event.preventDefault(e);
            validarClave('ContentPlaceHolder1_txt_tstal', 0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <i class="fa fa-user-circle" aria-hidden="true"></i>&nbsp;Estatus Alumno</h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tstal" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_periodos" runat="server">
                    <div class="form-row">
                        <div class="col-sm-2">
                            <label for="ContentPlaceHolder1_txt_tstal" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tstal" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqClave" ControlToValidate="txt_tstal" CssClass="text-danger" runat="server" ValidationGroup="guardar" ErrorMessage="Ingresar Clave"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-md-5">
                            ...
                            <asp:RequiredFieldValidator ID="reqDesc" ControlToValidate="txt_nombre" CssClass="text-danger" runat="server" ValidationGroup="guardar" ErrorMessage="Ingresar Descripción"></asp:RequiredFieldValidator>

                        </div>
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_ddl_tipo" class="form-label">Tipo</label>
                            <asp:DropDownList ID="ddl_tipo" runat="server" CssClass="form-control"></asp:DropDownList>                            
                            <asp:RequiredFieldValidator ID="reqTipo" ControlToValidate="ddl_tipo" CssClass="text-danger" runat="server" ValidationGroup="guardar" ErrorMessage="Seleccionar Tipo"></asp:RequiredFieldValidator>
                ...
                <div id="table_tstal">
                    <asp:GridView ID="Gridtstal" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="False" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtstal_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="C_TIPO" HeaderText="Tipo_code">
    ...
    <script>
        function load_datatable() {
            let table_periodo = $("#ContentPlaceHolder1_Gridtstal").DataTable({
                language: {
