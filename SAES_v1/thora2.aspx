<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="thora2.aspx.cs" Inherits="SAES_v1.thora" %>
    ...
    <div class="x_content">
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_zip" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:DropDownList ID="ddl_campus" runat="server" CssClass="form-control" Font-Size="Small" ></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-2">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_thora" runat="server">
                    <div class="col-md-6" style="text-align: center">
                        <asp:Button ID="cancel_thora" runat="server" CssClass="btn btn-round btn-secondary" Text="Cancelar" OnClick="cancel_thora_Click"/>
                        <asp:Button ID="save_thora" runat="server" CssClass="btn btn-round btn-success" Text="Agregar" OnClientClick="destroy_table();" OnClick="save_thora_Click"/>
                        <asp:Button ID="search_thora" runat="server" CssClass="btn btn-round btn-success" Text="Consultar" OnClientClick="destroy_table();" OnClick="grid_grupos_bind"/>
                        <asp:Button ID="update_thora" runat="server" CssClass="btn btn-round btn-success" Text="Actualizar" Visible="false" OnClientClick="destroy_table();" OnClick="save_thora_Click"/>
                    </div>
                </div>
                <div id="tabla_tgrup">
                    <asp:GridView ID="Gridthora" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridthora_SelectedIndexChanged">
                        <Columns>
                            <asp:ButtonField ButtonType="image" ImageUrl="~/Images/Generales/hacer-clic.png" ControlStyle-Height="24px" ControlStyle-Width="24px" CommandName="select" HeaderText="Seleccionar" ItemStyle-CssClass="button_select" />
                            <asp:BoundField DataField="CLAVE" HeaderText="Clave" />
                            <asp:BoundField DataField="MATERIA" HeaderText="Materia" />
                ...
                <div id="tabla_thora">
                    <asp:GridView ID="Gridthora1" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="GridCatalogo_Click">
                        <Columns>
                            <asp:ButtonField ButtonType="image" ImageUrl="~/Images/Generales/hacer-clic.png" ControlStyle-Height="24px" ControlStyle-Width="24px" CommandName="select" HeaderText="Seleccionar" ItemStyle-CssClass="button_select" />
