<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tdsap.aspx.cs" Inherits="SAES_v1.tdsap" %>
...
<i class="fa fa-external-link" aria-hidden="true"></i>
            ...
            <ContentTemplate>
                <div class="form-row" id="btn_tress" runat="server">
                    <div class="col-sm-12 text-center">
                        ...
                        <asp:Button ID="btn_save" runat="server" CssClass="btn btn-round btn-success" Text="Desaplicar" ValidationGroup="guardar" OnClick="btn_save_Click" />
        ...
        <div class="form-row">
            <div class="col">
                <asp:UpdatePanel ID="updPnlGrid" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="Gridtdsap" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="False" RowStyle-Font-Size="small" ShowHeaderWhenEmpty="True" EmptyDataText="No se encontraron datos.">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                ...
                                <asp:BoundField DataField="pago_clave" HeaderText="Concepto Pago" />
                                <asp:BoundField DataField="pago_desc" HeaderText="Descripción Pago" />
                                <asp:BoundField DataField="importe" HeaderText="Importe" />
                                <asp:BoundField DataField="fecha" HeaderText="Fecha" />
                                <asp:BoundField DataField="factura" HeaderText="Factura" />
                                <asp:BoundField DataField="factura_cons" HeaderText="Consec. Factura" />
                            </Columns>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalDesaplicar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col text-center">
                            <h3 class="font-weight-bold">¿Desaplicar pagos?</h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col text-center">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:LinkButton ID="linkBttnDesaplicar" runat="server" class="btn btn-success"   OnClick="linkBttnDesaplicar_Click">Si</asp:LinkButton>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
                    </div>
        ...
        <script>
            ...
            function load_datatable() {
                $('#<%= Gridtdsap.ClientID %>').prepend($("<thead></thead>").append($('#<%= Gridtdsap.ClientID %>').find("tr:first"))).DataTable({
                    "destroy": true,
                    "language": {
                        bProcessing: 'Procesando...',
                        sLengthMenu: 'Mostrar _MENU_ registros',
            ...
            function Confirm() {
                ...
                swal({
                    ...
                    cancelButtonText: "No soy",
                    closeOnConfirm: true,
                    closeOnCancel: true
                }).then((result) => {
                    const formulario = document.getElementById("ContentPlaceHolder1_hdnConf");
                    formulario.submit();
                })
            }
        </script>
