                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                ...
                                <%--<asp:ImageButton ID="ImgConsulta" runat="server" ImageUrl="Images/Operaciones/busca.png" Height="20px" Width="20px"
                                    ToolTip="Búsqueda" Visible="true" OnClick="grid_tpron_bind" />--%>
                                <asp:LinkButton ID="linkBttnBuscar" runat="server" OnClick="grid_tpron_bind" CssClass="btn btn-success"><i class="fa fa-search" aria-hidden="true"></i></asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <ItemTemplate>
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon1"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
                                            </span>
                                        </div>
                                        <asp:TextBox ID="pronostico" runat="server" CssClass="form-control"
