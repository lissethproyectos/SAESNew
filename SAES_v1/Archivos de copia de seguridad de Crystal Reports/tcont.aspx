...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_content">
        ...
        <asp:UpdatePanel ID="upd_tcont" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="row" id="btn_tcont" runat="server">
                ...
                <div class="row" id="Div1" runat="server">
                    <div class="col">
                        <asp:GridView ID="Gridtcont" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtcont_SelectedIndexChanged" EmptyDataText="No se encontraron contactos." ShowHeaderWhenEmpty="True">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
    ...
    <script>
        function load_datatable() {
            $('#<%= Gridtcont.ClientID %>').prepend($("<thead></thead>").append($('#<%= Gridtcont.ClientID %>').find("tr:first"))).DataTable({
                language: {
