...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Catálogo Estatus Solicitud</h2>
    ...
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tstso" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="row" id="btn_tstso" runat="server">
                ...
                <div id="table_tstso">
                    <asp:GridView ID="Gridtstso" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="False" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtstso_SelectedIndexChanged" ShowHeaderWhenEmpty="True">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
    ...
    <script>
        function load_datatable() {
            $('#<%= Gridtstso.ClientID %>').prepend($("<thead></thead>").append($('#<%= Gridtstso.ClientID %>').find("tr:first"))).DataTable({
                language: {
