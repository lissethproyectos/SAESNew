...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
   ...
   <script>
       ...
       function fecha_fuera_periodo() {
            swal({
                allowEscapeKey: false,
                allowOutsideClick: false,
                type: 'error',
                html: '<h2 class="swal2-title" id="swal2-title">ERROR -- Fecha fuera de Periodo Escolar o fecha futura</h2>'
            })
       }

       function fecha_fuera_rango() {
            swal({
                allowEscapeKey: false,
                allowOutsideClick: false,
                type: 'error',
                html: '<h2 class="swal2-title" id="swal2-title">ERROR -- Sólo se puede capturar inasistencias con 3 días de anterioridad </h2>'
            })
       }

       function fecha_futura() {
            swal({
                allowEscapeKey: false,
                allowOutsideClick: false,
                type: 'error',
                html: '<h2 class="swal2-title" id="swal2-title">ERROR -- No se pueden capturar inasistencias en fecha futura </h2>'
            })
        }
