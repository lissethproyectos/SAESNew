<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tctel.aspx.cs" Inherits="SAES_v1.Tctel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Admisiones/buscar.png" style="width: 30px;" /><small>Consulta Teléfonos</small></h2>
...
<%--                <asp:LinkButton ID="back" runat="server" CssClass=" icon_regresa  btn-outline-secondary" OnClick="back_Click"><i class="fas fa-arrow-circle-left fa-2x"></i></asp:LinkButton>--%>
                ...
                <div id="table_tcdoc">
                    <asp:GridView ID="GridTelefonos" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small">
                         <Columns>
                            ...
                            <asp:BoundField DataField="tipo_tele" HeaderText="Tipo" />
                            <asp:BoundField DataField="lada" HeaderText="Lada" />
                            <asp:BoundField DataField="telefono" HeaderText="Teléfono" />
                             <asp:BoundField DataField="ext" HeaderText="Extensión" />
    ...
    <script>
        function load_datatable() {
            let table_solicitudes = $("#ContentPlaceHolder1_GridTelefonos").DataTable({
                language: {
