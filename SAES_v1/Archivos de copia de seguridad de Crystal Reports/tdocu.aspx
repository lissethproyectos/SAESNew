...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div class="form-row">
            <div class="col-sm-2">
                Clave
                             <asp:UpdatePanel ID="upd_tdocu" runat="server">
                                 <ContentTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            <ContentTemplate>
                <div class="form-row" style="text-align: center; margin: auto;" id="btn_tdocu" runat="server">
        ...
        <div class="row">
            <div class="col">
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="Gridtdocu" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtdocu_SelectedIndexChanged" EmptyDataText="No se encontraron documentos." ShowHeaderWhenEmpty="True">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
