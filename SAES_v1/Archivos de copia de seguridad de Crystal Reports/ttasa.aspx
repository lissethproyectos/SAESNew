<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ttasa.aspx.cs" Inherits="SAES_v1.ttasa" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
   ...
   <script>
       ...
       function validar_campos_ttasa(e) {
           event.preventDefault(e);
           validarClave('ContentPlaceHolder1_txt_ttasa',0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <img src="Images/Admisiones/solicitud.png" style="width: 30px;" /><small>Catálogo Tasa financiera</small></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_ttasa" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_ttasa" runat="server">
                    <div class="row g-3 justify-content-center" style="margin-top: 15px;">
                        <div class="col-md-3">
                            <label for="ContentPlaceHolder1_txt_ttasa" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_ttasa" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row justify-content-center" style="text-align: center; margin: auto;" id="btn_ttasa" runat="server">
                ...
                <div id="table_ttasa">
                    <asp:GridView ID="Gridttasa" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridttasa_SelectedIndexChanged">
                        <Columns>
 ...
 <script>
     ...
     function destroy_table() {
         $("#ContentPlaceHolder1_Gridttasa").DataTable().destroy();
     }
