    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col font-weight-bold">
                <h2>
                    <i class="fa fa-user-circle" aria-hidden="true"></i>&nbsp;Datos Personales</h2>
                <hr />
            </div>
        </div>
        <div class="form-row">
        ...
        <div class="row" id="btn_tpers" runat="server">
            <div class="col text-center">
                <asp:UpdatePanel ID="updPnlBotones" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Button ID="btn_update" runat="server" CssClass="btn btn-round btn-success" Text="Actualizar" OnClick="btn_update_Click" Visible="False" />
                        <asp:Button ID="btn_datos_grals" runat="server" CssClass="btn btn-round btn-success" Text="Consulta Datos Generales" OnClick="btn_datos_grals_Click" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridSolicitudes" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="GridSolicitudes_SelectedIndexChanged" ShowHeaderWhenEmpty="True">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
