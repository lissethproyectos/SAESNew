...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            ...
            &nbsp;Tipos de Correo Electrónico</h2>
    ...
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tmail" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="row" id="btn_tmail" runat="server">
                ...
                <div class="row">
                    <div class="col">
                        <asp:GridView ID="Gridtmail" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtmail_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No se encontraron correos.">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
    ...
    <script>
        function load_datatable() {
                $('#<%= Gridtmail.ClientID %>').prepend($("<thead></thead>").append($('#<%= Gridtmail.ClientID %>').find("tr:first"))).DataTable({
                language: {
