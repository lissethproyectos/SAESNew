<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tespr.aspx.cs" Inherits="SAES_v1.tespr" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function validar_campos_tespr(e) {
            event.preventDefault(e);
            validarClave('ContentPlaceHolder1_txt_tespr', 0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            ...
            &nbsp;Escuelas de Procedencia</h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tespr" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_periodos" runat="server">
                    <div class="form-row">
                        <div class="col-sm-2">
                            <label for="ContentPlaceHolder1_txt_tespr" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tespr" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqClave" runat="server" ErrorMessage="Ingresar Clave" ValidationGroup="guardar" CssClass="text-danger" ControlToValidate="txt_tespr"></asp:RequiredFieldValidator>
                        ...
                        <div class="col-sm-7">
                            ...
                            <asp:RequiredFieldValidator ID="reqDescripcion" runat="server" ErrorMessage="Ingresar Descripción" ValidationGroup="guardar" CssClass="text-danger" ControlToValidate="txt_nombre"></asp:RequiredFieldValidator>
                        ...
                        <div class="col-sm-3">
                            ...
                            <asp:RequiredFieldValidator ID="reqEstatus" runat="server" ErrorMessage="Seleccionar Estatus" ValidationGroup="guardar" CssClass="text-danger" InitialValue="0" ControlToValidate="ddl_estatus"></asp:RequiredFieldValidator>

                        </div>
                    </div>
                </div>
                <br />
                <div class="row text-center" id="btn_tespr" runat="server">
                    <div class="col">
                        <asp:Button ID="btn_cancel" runat="server" CssClass="btn btn-round btn-secondary" Text="Cancelar" OnClick="btn_cancel_Click" ValidationGroup="guardar" />
                ...
                <div class="row">
                    <div class="col">
                        <asp:GridView ID="Gridtespr" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtespr_SelectedIndexChanged">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
    ...
    <script>
        function load_datatable() {
            let table_periodo = $("#ContentPlaceHolder1_Gridtespr").DataTable({
                language: {
                ...
                buttons: [
                    {
                        title: 'SAES_Catálogo Escuelas Procedencia',
                        className: 'btn-dark',
                        extend: 'excel',
                        text: 'Exportar Excel',
                        exportOptions: {
