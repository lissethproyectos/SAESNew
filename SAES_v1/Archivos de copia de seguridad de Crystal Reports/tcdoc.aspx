    ...
    <div class="x_content">
        ...
        <asp:UpdatePanel ID="upd_c_documentos" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="row">
                    <div class="col">
                    <asp:GridView ID="GridCDocumentos" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" ShowHeaderWhenEmpty="True">
                        <Columns>
