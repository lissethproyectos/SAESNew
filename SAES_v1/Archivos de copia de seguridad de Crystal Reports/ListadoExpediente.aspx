<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadoExpediente.aspx.cs" Inherits="SAES_v1.Repositorio.ListadoExpediente" %>
    ...
    <script>
        ...
        function NoExiste() {
            swal({
                ...
                type: 'error',
                html: '<h2 class="swal2-title" id="swal2-title">No existe Documento cargado</h2>'
            })
        }
        ...
        function NoComen() {
            swal({
                ...
                allowOutsideClick: false,
                type: 'error',
                html: '<h2 class="swal2-title" id="swal2-title">No hay registro de comentarios</h2>'
            })
        }
    </script>
    <style>
        ...
        <div class="row">
            <div class="col">
                <asp:UpdatePanel runat="server" ID="updatepanel1">
                    <ContentTemplate>
                        <asp:GridView ID="gvExpediente" runat="server" AutoGenerateColumns="False" Width="100%" DataKeyNames="IDTipoDocumento" CssClass="table table-striped table-bordered" OnRowCommand="gvExpediente_RowCommand" OnRowDataBound="gvExpediente_RowDataBound" EmptyDataText="No se encontro expediente." ShowHeaderWhenEmpty="True">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Estatus" HeaderText="Estatus" ControlStyle-BackColor="Window" />
                                <asp:BoundField DataField="Limite" HeaderText="Fecha Límite" />
                                <asp:TemplateField ShowHeader="false" HeaderText="Comentarios de Revisión">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="imgComentarios" runat="server" CssClass="btn btn-secondary" CommandName="Comentarios" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                            AlternateText="Subir Archivo" Visible="true" OnClientClick="CallButtonEvent()"><i class="fa fa-file-text" aria-hidden="true"></i></i></asp:LinkButton>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField ShowHeader="False" HeaderText="Subir Documento">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="imgExpediente" runat="server" CssClass="btn btn-secondary" CommandName="Subir" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                            AlternateText="Subir Archivo" Visible="true" OnClientClick="CallButtonEvent()"><i class="fa fa-upload" aria-hidden="true"></i></i></asp:LinkButton>
                                ...
                                <asp:TemplateField ShowHeader="False" HeaderText="Ver Documento">
                                    <ItemTemplate>
                                        <%--<a id="pop" href="InputFile.aspx"> <img border="0" src="Images/Carga_Documentos/Upload_n.png"></a>--%>
                                        <asp:LinkButton ID="imgPreview" runat="server" CssClass="btn btn-secondary" CommandName="Preview" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                            AlternateText="Vista Previa" Visible="true"><i class="fa fa-file" aria-hidden="true"></i></asp:LinkButton>
