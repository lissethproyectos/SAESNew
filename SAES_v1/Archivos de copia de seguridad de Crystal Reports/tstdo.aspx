<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tstdo.aspx.cs" Inherits="SAES_v1.tstdo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function validar_campos_tstdo(e) {
            event.preventDefault(e);
            validarClave('ContentPlaceHolder1_txt_tstdo', 0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="x_title">
        <h2>
            ...
            &nbsp;Estatus de Documentos</h2>
        <div class="clearfix"></div>
    </div>


    <div class="container-fluid">
        <asp:UpdatePanel ID="upd_tstdo" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_periodos" runat="server">
                    <div class="form-row">
                        <div class="col-sm-2">
                            Clave
                            <asp:TextBox ID="txt_tstdo" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqClave" runat="server" ErrorMessage="Ingresar Clave" ValidationGroup="guardar" CssClass="text-danger" ControlToValidate="txt_tstdo"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-sm-7">
                            Descripción
                            <asp:TextBox ID="txt_nombre" MaxLength="60" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqNombre" runat="server" ErrorMessage="Ingresar Nombre" ValidationGroup="guardar" CssClass="text-danger" ControlToValidate="txt_nombre"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-sm-3">
                            Estatus
                ...
                <br />
                <div class="row" id="btn_tstdo" runat="server">
                ...
                <div class="row">
                    <div class="col">
                        <asp:GridView ID="Gridtstdo" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="False" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtstdo_SelectedIndexChanged">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
    ...
    <script>
        function load_datatable() {
            let table_periodo = $("#ContentPlaceHolder1_Gridtstdo").DataTable({
                language: {
                ...
                buttons: [
                    {
                        title: 'SAES_Catálogo de Tipos stdocción',
                        className: 'btn-dark',
                        extend: 'excel',
                        text: 'Exportar Excel',
                        exportOptions: {
        ...
        function destroy_table() {
            $("#ContentPlaceHolder1_Gridtstdo").DataTable().destroy();
        }
