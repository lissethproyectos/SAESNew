<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tnive.aspx.cs" Inherits="SAES_v1.tnive" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function validar_campos_ttiin(e) {
            event.preventDefault(e);
            validarClave('ContentPlaceHolder1_txt_ttiin', 0);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="x_title">
        <h2>
            <i class="fa fa-graduation-cap" aria-hidden="true"></i>&nbsp;Niveles Educativos
        </h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <asp:UpdatePanel ID="upd_tnive" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="form_tnive" runat="server">
                    <div class="form-row">
                        <div class="col-sm-2">
                            <label for="ContentPlaceHolder1_txt_tnive" class="form-label">Clave</label>
                            <asp:TextBox ID="txt_tnive" MaxLength="3" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="reqCveNivel" CssClass="text-danger" runat="server" ErrorMessage="Ingresar clave" ControlToValidate="txt_tnive" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                        </div>
                        <div class="col-sm-7">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" CssClass="text-danger" runat="server" ErrorMessage="Ingresar descripción" ControlToValidate="txt_nombre" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                        ...
                        <div class="col-sm-3">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" CssClass="text-danger" runat="server" ErrorMessage="Seleccionar estatus" ControlToValidate="ddl_estatus" ValidationGroup="guardar"></asp:RequiredFieldValidator>

                        </div>
                    </div>
                </div>
                <div class="row" id="btn_tnive" runat="server">
                ...
                <div id="table_tnive">
                    <asp:GridView ID="Gridtnive" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtnive_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
    ...
    <script>
        function load_datatable() {
            let table_periodo = $("#ContentPlaceHolder1_Gridtnive").DataTable({
                ...
                buttons: [
                    {
                        title: 'SAES_Catálogo Nivel Educativo',
                        className: 'btn-dark',
                        extend: 'excel',
                        text: 'Exportar Excel',
                        exportOptions: {
        ...
        function destroy_table() {
            $("#ContentPlaceHolder1_Gridttnive").DataTable().destroy();
        }
