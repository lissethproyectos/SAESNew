<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard_RI.aspx.cs" Inherits="SAES_v1.Dashboard_RI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="form-row">
            <div class="col">
                <h6><i class="fa fa-tachometer fa-2x" aria-hidden="true"></i>Tablero de Pronostico de Reingreso</h6>
            </div>
        </div>
        <hr />
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <asp:UpdatePanel ID="updPnlTurno" runat="server">
                <ContentTemplate>
                    <asp:DropDownList runat="server" ID="ddl_turno" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddl_turno_SelectedIndexChanged"></asp:DropDownList>
                </ContentTemplate>
            </asp:UpdatePanel>
            </div>
            <div class="col-sm-3">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="grvDatosGrafica" runat="server" CssClass="table table-striped table-bordered" EmptyDataText="No se encontraron datos." ShowHeaderWhenEmpty="True" Width="100%" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:BoundField DataField="registros_ri" HeaderText="Registros RI">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <ItemStyle Font-Size="10px" HorizontalAlign="Center" />
                                </asp:BoundField>
