...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="form-row">
            <div class="col-sm-3">
             ...
             <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                 <ContentTemplate>
                     <asp:DropDownList ID="ddl_tnive" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddl_tnive_SelectedIndexChanged"></asp:DropDownList>
                 </ContentTemplate>
             </asp:UpdatePanel>
            </div>
            <div class="col-sm-2">
    ...
    <div class="container-fluid">
        ...
        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
            <ContentTemplate>
                <div class="row" id="btn_tcali" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
            <ContentTemplate>
                <div class="row" id="Div1" runat="server">
                    <div class="col">
                        <asp:GridView ID="Gridtcali" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="Gridtcali_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No se encontraron calificaciones.">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
    ...
    <script>
        function load_datatable_tcali() {
            $('#<%= Gridtcali.ClientID %>').prepend($("<thead></thead>").append($('#<%= Gridtcali.ClientID %>').find("tr:first"))).DataTable({
                language: {
