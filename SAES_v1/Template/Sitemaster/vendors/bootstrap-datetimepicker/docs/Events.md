...
Fired (in most cases) when the `viewDate` changes. E.g. Next and Previous buttons, selecting a nivel.

Parameters:

```
e = {
   change, //Change type as a momentjs format token. Type: string e.g. yyyy on nivel change
