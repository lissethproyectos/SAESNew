<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tdodi.aspx.cs" Inherits="SAES_v1.tdodi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function NoexisteDocente() {
            swal({
                allowEscapeKey: false,
                allowOutsideClick: false,
                type: 'error',
                html: '<h2 class="swal2-title" id="swal2-title">ERROR !!</h2>Docente NO existe'
            })
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        <div id="form_tdodi" runat="server">
            <div class="form-row">
                <div class="col-sm-2">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                        <ContentTemplate>
                            <div class="input-group">
                                <asp:TextBox ID="txt_matricula" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txt_matricula_TextChanged"></asp:TextBox>
                ...
                <div class="col-sm-4">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="reqNombre" runat="server" ControlToValidate="txt_nombre" CssClass="text-danger" ErrorMessage="Ingresar Nombre" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                ...
                <div class="col-sm-3">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="reqTipo" runat="server" ErrorMessage="Seleccionar Tipo" ControlToValidate="ddl_tipo_direccion" CssClass="text-danger" ValidationGroup="guardar" InitialValue="0"></asp:RequiredFieldValidator>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <div class="col-sm-3">
            ...
            <div class="form-row">
                <div class="col">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="GridDocente" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="GridDocente_SelectedIndexChanged">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                ...
                <div class="col-sm-6">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="reqPais" runat="server" ErrorMessage="Seleccionar Pais" ControlToValidate="ddl_pais" ValidationGroup="guardar" CssClass="text-danger" InitialValue="0"></asp:RequiredFieldValidator>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <div class="col-sm-6">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="reqEstado" runat="server" ErrorMessage="Seleccionar Estado" ControlToValidate="ddl_estado" ValidationGroup="guardar" CssClass="text-danger" InitialValue="0"></asp:RequiredFieldValidator>
            ...
            <div class="form-row">
                <div class="col-sm-9">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddl_delegacion" runat="server" CssClass="form-control" AutoPostBack="true"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="reqDelegacion" runat="server" ErrorMessage="Seleccionar Delegación" ControlToValidate="ddl_delegacion" ValidationGroup="guardar" CssClass="text-danger" InitialValue="0"></asp:RequiredFieldValidator>
                ...
                <div class="col-sm-3">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="reqCP" runat="server" ErrorMessage="Ingresar Código Postal" ControlToValidate="txt_zip" ValidationGroup="guardar" CssClass="text-danger"></asp:RequiredFieldValidator>

                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="txt_zip" EventName="TextChanged" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
            </div>
            ...
            <div class="col">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridCP" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="GridCP_SelectedIndexChanged" Visible="false">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="linkBttSel" runat="server" CausesValidation="False" CommandName="Select" Text="Seleccionar">
            ...
            <div class="form-row">
                <div class="col-sm-4">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddl_colonia" runat="server" CssClass="form-control" AutoPostBack="True"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Seleccionar Colonia" ControlToValidate="ddl_colonia" ValidationGroup="guardar" CssClass="text-danger" InitialValue="0"></asp:RequiredFieldValidator>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <div class="col-sm-4">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="reqCiudad" runat="server" ControlToValidate="txt_ciudad" ValidationGroup="guardar" CssClass="text-danger" ErrorMessage="Ingresar Ciudad"></asp:RequiredFieldValidator>
        ...
        <br />
        <div class="row text-center" id="btn_tdodi" runat="server">
            <div class="col">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="btn_cancel" runat="server" CssClass="btn btn-round btn-secondary" Visible="true" Text="Cancelar" OnClick="btn_cancel_Click" />
                        ...
                        <asp:Button ID="btn_consultar" runat="server" CssClass="btn btn-round btn-success" Text="Consulta Direcciones" OnClick="btn_consultar_Click" />
        ...
        <div class="row">
            <div class="col">
                <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridDireccion" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="false" RowStyle-Font-Size="small" OnSelectedIndexChanged="GridDireccion_SelectedIndexChanged" EmptyDataText="No se encontraron direcciones." ShowHeaderWhenEmpty="True">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="linkBttSel" runat="server" CausesValidation="False" CommandName="Select" Text="Seleccionar">
    ...
    <script>
        function load_datatable() {
            let table_solicitudes = $("#ContentPlaceHolder1_GridDireccion").DataTable({
                ...
                buttons: [
                    {
                        title: 'SAES_Direcciones docente',
                        className: 'btn-dark',
                        extend: 'excel',
                        text: 'Exportar Excel',
                        exportOptions: {
        ...
        function load_datatable_Docente() {
            $('#<%= GridDocente.ClientID %>').prepend($("<thead></thead>").append($('#<%= GridDocente.ClientID %>').find("tr:first"))).DataTable({
                language: {
                    bProcessing: 'Procesando...',
                    sLengthMenu: 'Mostrar _MENU_ registros',
                    sZeroRecords: 'No se encontraron resultados',
