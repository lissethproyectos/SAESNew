<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tmenu.aspx.cs" Inherits="SAES_v1.tmenu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
            ...
            <div class="col-sm-8">Descripción
        ...
        <div class="row">
            <div class="col">
                <asp:UpdatePanel ID="updPnlMenu" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="grdMenu" runat="server" CssClass="table table-striped table-bordered" Width="100%" AutoGenerateColumns="False" EmptyDataText="No se encontraron datos." ShowHeaderWhenEmpty="True" OnSelectedIndexChanged="grdMenu_SelectedIndexChanged">
                            <Columns>
                                ...
                                <asp:BoundField DataField="menu_clave" HeaderText="Clave" />
                                <asp:BoundField DataField="menu_desc" HeaderText="Descripción" />
                                <asp:BoundField DataField="menu_date" HeaderText="Fecha Reg" />
                                <asp:BoundField DataField="menu_estatus" HeaderText="Estatus" />
                            </Columns>
